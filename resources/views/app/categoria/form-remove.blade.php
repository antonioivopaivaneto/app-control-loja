<div class="modal fade" id="modalRemove{{$c->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{route('categoria.destroy',$c->id)}}" >
                    @csrf
                    @method('DELETE')

                   <h2>Deseja remover essa categoria?</h2>
